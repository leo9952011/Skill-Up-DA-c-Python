...
sql_file = sql_path / ('GBUSalvador.sql')
## Ubicacion de .csv
csv_path = root_path / 'files'
csv_file = csv_path / ('GBUSalvador_select.csv')
## Ubicacion de.txt
txt_path = root_path / 'datasets'
txt_file = txt_path / ('GBUSalvador_process.txt')

# ------- LOGGER ------------------
def configure_logger():
    logger_name = 'GBUSalvador_dag_etl'
...
def transform_task():
    ...
    csv_a_txt(univ='USalvador', in_file=csv_file, out_file=txt_file)    
