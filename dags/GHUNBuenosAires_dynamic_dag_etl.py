...
def extract_task():
    ...
    # Read SQL query
    sql_filepath = local_basepath / 'include/GHUNBuenosAires_dynamic_dag_etl.sql'
    ...
    csv_filepath = local_basepath / 'files/GHUNBuenosAires_dynamic_dag_etl_select.csv'
...
def transform_task():
    ...
    csv_path = local_basepath / 'files/GHUNBuenosAires_dynamic_dag_etl_select.csv'
    txt_path = local_basepath / 'datasets/GHUNBuenosAires_dynamic_dag_etl_process.txt'
...
with DAG('AUTO_GHUNBuenosAires_dynamic_dag_etl_dag_etl',
